            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-12 col-12">
                        ...
                        <h2 class="breadcrumb-title">My Posts <span style="color: #26a9e166">+</span></h2>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <ul class="entry-meta meta-item">
                                        <li>
                                            <div class="post-author">
                                                <a href="#"><img src="{{url('/storage/profile_images/'.auth()->user()->profile_picture ) }}" alt="Post Author"> <span>Dr. {{$post->author}}</span></a>
                                            </div>
                                        </li>
                ...
                <form action="" id="deleteForm" method="post">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            {{ csrf_field() }}
                            {{ method_field('DELETE') }}
                            <p id="acc_msg">Are you really to want to delete this Post?</p>
                        </div>
